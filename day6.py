...
async def monday(ctx):
    ...
    t2_1 = convert(overhead, 50, 6)
    t2_2 = convert(overhead, 60, 5)
    t2_3 = convert(overhead, 70, 3)
    t2_4 = convert(overhead, 70, 5)
    t2_5 = convert(overhead, 70, 7)
    t2_6 = convert(overhead, 70, 4)
    t2_7 = convert(overhead, 70, 6)
    t2_8 = convert(overhead, 70, 8)
...
async def wednesday(ctx):
    ...
    warmup_1 = convert(overhead, 40, 5)
    warmup_2 = convert(overhead, 50, 5)
    warmup_3 = convert(overhead, 60, 5)
    t1_1 = convert(overhead, 75, 5)
    t1_2 = convert(overhead, 85, 3)
    t1_3 = convert(overhead, 95, 1)
    t1_4 = convert(overhead, 90, 3) 
    t1_5 = convert(overhead, 85, 3)
    t1_6 = convert(overhead, 80, 3)
    t1_7 = convert(overhead, 75, 5)
    t1_8 = convert(overhead, 70, 5)
    t1_9 = convert(overhead, 65, 5)
...
async def friday(ctx):
    ...
    t1_5 = convert(bench, 85, 5)
    t1_6 = convert(bench, 80, 3)
    t1_7 = convert(bench, 75, 5)
    t1_8 = convert(bench, 70, 3)
...
async def saturday(ctx):
    ...
    warmup_2 = convert(deadlift, 50, 5)
    warmup_3 = convert(deadlift, 60, 5)
    t1_1 = convert(deadlift, 72.5, 3)
    t1_2 = convert(deadlift, 72.5, 3)
    t1_3 = convert(deadlift, 72.5, 3)
    t1_4 = convert(deadlift, 72.5, 3)
    t1_5 = convert(deadlift, 72.5, 3)
    t1_6 = convert(deadlift, 72.5, 3)
    t1_7 = convert(deadlift, 72.5, 3)
    t1_8 = convert(deadlift, 72.5, 3)
    t2_1 = convert(squat, 56.25, 3)
    t2_2 = convert(squat, 56.25, 3)
    t2_3 = convert(squat, 56.25, 3)
    t2_4 = convert(squat, 56.25, 3)
    t2_5 = convert(squat, 56.25, 3)
    t2_6 = convert(squat, 56.25, 3)
    ...
    ***WARMUP - DEADLIFT***\n\
    ...
    {t2_4}\n\
    {t2_5}\n\
    {t2_6}\n\nRecommended accessory work: Upper back and legs.\
    """.format(warmup1=warmup_1, warmup2=warmup_2, warmup3=warmup_3, t1_1=t1_1, t1_2=t1_2, t1_3=t1_3, t1_4=t1_4, t1_5=t1_5, t1_6=t1_6, t1_7=t1_7, t1_8=t1_8, t2_1=t2_1, t2_2=t2_2, t2_3=t2_3, t2_4=t2_4, t2_5=t2_5, t2_6=t2_6)
